...
const AIInsightsPart2: NextPage = () => {
  return (
    <div className="relative bg-white w-full h-[758px] overflow-hidden text-center text-base text-black font-inter">
      ...
      <img
        className="absolute top-[253px] left-[11px] w-[276px] h-[58px] object-cover"
        alt=""
      ...
      <div className="absolute top-[17px] left-[0px] box-border w-[1280px] h-[741px] overflow-hidden border-[3px] border-solid border-black">
        ...
        <div className="absolute top-[515px] left-[1082px] w-[198px] h-[129.2px] text-left text-77xl">
          ...
          />
          <img
            className="absolute h-[16.41%] w-[10.71%] top-[83.59%] right-[53.94%] bottom-[0%] left-[35.35%] max-w-full overflow-hidden max-h-full object-contain"
            alt=""
        ...
        <img
          className="absolute h-[3.12%] w-[2.08%] top-[0.94%] right-[76.59%] bottom-[95.94%] left-[21.33%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/group@2x.png"
        />
