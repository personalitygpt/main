  ...
  return (
    <div className="relative bg-white w-full h-[758px] overflow-hidden text-center text-base text-black font-inter">
      ...
      <div className="absolute top-[22px] left-[0px] box-border w-[1280px] h-[736px] overflow-hidden border-[3px] border-solid border-black">
        ...
        <div className="absolute top-[229px] left-[381px] w-[65px] h-[65px]">
          <img
        ...
        <div className="absolute top-[565px] left-[392px] w-[65px] h-[65px]">
          <img
            className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/image-15@2x.png"
        ...
        <div className="absolute top-[162px] left-[19px] w-[276px] h-[81px]">
          ...
          <div className="absolute h-[53.09%] w-[4.35%] top-[7.41%] right-[5.43%] bottom-[39.51%] left-[90.22%]">
            <img
              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
              src="/more-than@2x.png"
        ...
        <div className="absolute top-[316px] left-[19px] w-[276px] h-[83px]">
          ...
          <div className="absolute h-[51.81%] w-[4.35%] top-[10.84%] right-[5.07%] bottom-[37.35%] left-[90.58%]">
            <img
              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
              src="/more-than@2x.png"
        ...
        <div className="absolute top-[560px] left-[15px] w-[276px] h-[84px]">
          ...
          <div className="absolute h-[51.19%] w-[4.35%] top-[9.52%] right-[6.16%] bottom-[39.29%] left-[89.49%]">
            <img
              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
              src="/more-than@2x.png"
      ...
      <div className="absolute top-[416px] left-[17px] w-[276px] h-[79px]">
        ...
        <div className="absolute h-[54.43%] w-[4.35%] top-[10.13%] right-[5.8%] bottom-[35.44%] left-[89.86%]">
          <img
            className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/more-than@2x.png"
