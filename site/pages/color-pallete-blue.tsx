    ...
    <div className="relative bg-white w-full h-[758px] overflow-hidden text-center text-11xl text-black font-inter">
      ...
      <div className="absolute top-[22px] left-[-2px] box-border w-[1280px] h-[736px] overflow-hidden border-[3px] border-solid border-black">
        ...
        <div className="absolute top-[288px] left-[579px] w-[393px] h-[85px]">
          ...
          <img
            className="absolute h-[34.12%] w-[7.38%] top-[32.94%] right-[86.26%] bottom-[32.94%] left-[6.36%] max-w-full overflow-hidden max-h-full object-cover hidden"
            alt=""
        ...
        <div className="absolute top-[239px] left-[585px] w-[347px] h-[29px]">
          ...
          <img
            className="absolute h-full w-[8.36%] top-[0%] right-[29.97%] bottom-[0%] left-[61.67%] max-w-full overflow-hidden max-h-full object-cover hidden"
            alt=""
        ...
        >
          <div className="absolute h-[67.71%] w-[11.36%] top-[32.29%] right-[0%] bottom-[0%] left-[88.64%] rounded-3xs bg-dodgerblue-200">
            <div className="absolute top-[23.08%] left-[26.03%]">back</div>
          </div>
          <img
            className="absolute top-[0px] left-[0px] w-[678px] h-[57px] object-cover mix-blend-lighten"
            alt=""
            src="/rectangle-66@2x.png"
          />
        </div>
        <img
          className="absolute h-[3.94%] w-[2.27%] top-[32.47%] right-[35.16%] bottom-[63.59%] left-[62.58%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/ellipse-9@2x.png"
        />
