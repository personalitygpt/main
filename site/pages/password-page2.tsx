...
const PasswordPage2: NextPage = () => {
  return (
    <div className="relative bg-white w-full h-[761px] overflow-hidden text-center text-11xl text-black font-inter">
      ...
      <div className="absolute top-[316px] left-[6px] w-[299px] h-[148px] text-31xl font-magra">
        <div className="absolute h-full w-full top-[0%] left-[0%] tracking-[-0.32px] leading-[21px] inline-block">
      ...
      <div className="absolute top-[297px] left-[359px] w-[710px] h-[60px] text-21xl text-darkgray-200">
        <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] bg-gainsboro" />
        <div className="absolute top-[20px] left-[18px] w-[183px] h-[21px]">
          <div className="absolute top-[0%] left-[0%] tracking-[-0.32px] leading-[21px]">
            Password
          </div>
        </div>
        <div className="absolute top-[21px] left-[573px] w-[114px] h-[21px] text-6xl text-black">
          <div className="absolute top-[0%] left-[0%] tracking-[-0.32px] leading-[21px]">
            Password
          </div>
        </div>
