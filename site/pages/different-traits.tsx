  ...
  return (
    <div className="relative bg-white w-full h-[757px] overflow-hidden text-left text-xl text-black font-inter">
      <div className="absolute top-[0px] left-[0px] w-[1280px] h-[758px]">
        ...
        <div className="absolute h-[97.1%] w-full top-[2.9%] right-[0%] bottom-[0%] left-[0%] box-border overflow-hidden text-center text-base border-[3px] border-solid border-black">
          ...
          <div className="absolute h-[10.73%] w-[21.56%] top-[48.78%] right-[77.19%] bottom-[40.49%] left-[1.25%]">
            <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%]">
              <div className="absolute h-[73.42%] w-full top-[0%] right-[0%] bottom-[26.58%] left-[0%] rounded-2xl bg-lightgray" />
              <div className="absolute h-[89.87%] w-[27.54%] top-[10.13%] left-[36.59%] tracking-[-0.32px] leading-[21px] inline-block">
                Different Traits
              </div>
            </div>
          </div>
          <div className="absolute h-[5.84%] w-[0.94%] top-[60.6%] right-[78.05%] bottom-[33.56%] left-[21.02%]">
            <img
        ...
        <div className="absolute h-[8.58%] w-[28.83%] top-[89.84%] left-[41.8%] text-17xl text-dimgray inline-block">
          {" "}
          Type Here...
        </div>
        <div className="absolute h-[8.58%] w-[28.83%] top-[89.84%] left-[41.8%] text-17xl text-dimgray inline-block">
        ...
        <div className="absolute h-[1.98%] w-[1.17%] top-[76.86%] right-[61.64%] bottom-[21.16%] left-[37.19%] bg-gainsboro [transform:_rotate(-45deg)] [transform-origin:0_0]" />
        <div className="absolute h-[9.5%] w-[70.47%] top-[11.21%] left-[27.03%] text-21xl tracking-[-0.32px] leading-[21px] text-center inline-block">
          Different Traits
        </div>
        <img
          className="absolute h-[8.05%] w-[4.77%] top-[32.59%] right-[66.02%] bottom-[59.37%] left-[29.22%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/image-2@2x.png"
        />
        <img
        ...
        <img
          className="absolute h-[8.05%] w-[4.77%] top-[76.91%] right-[66.02%] bottom-[15.04%] left-[29.22%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/image-2@2x.png"
        />
        <img
        ...
        <div className="absolute h-[16.09%] w-[26.88%] top-[58.84%] left-[35.55%] tracking-[-0.32px] leading-[21px] inline-block">
          ...
          emotions. It is not an inherently “bad” personality trait, as it
        ...
        <div className="absolute w-[24.77%] top-[44.33%] left-[66.88%] tracking-[-0.32px] leading-[21px] inline-block">
          I just took the test and was deemed neurotic. What does this mean and
          is it bad?
        </div>
        <div className="absolute h-[8.31%] w-1/5 top-[22.96%] left-[34.3%] tracking-[-0.32px] leading-[21px] inline-block">
          Hello! How would you like me to assist you?
        </div>
        <div className="absolute h-[5.94%] w-[39.92%] top-[89.58%] right-[21.25%] bottom-[4.49%] left-[38.83%] rounded-2xl bg-gainsboro" />
        <div className="absolute h-[4.49%] w-[32.81%] top-[90.63%] left-[39.3%] text-6xl text-dimgray inline-block">
          {" "}
          Type Here...
        </div>
        <img
      ...
      <div className="absolute top-[56px] left-[18px] w-[276px] h-[69px] text-center text-base">
        ...
        <img
          className="absolute h-[62.32%] w-[4.35%] top-[13.04%] right-[4.35%] bottom-[24.64%] left-[91.3%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/more-than@2x.png"
        />
      </div>
